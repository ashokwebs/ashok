      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            '@type': 'SoftwareApplication',
            position: 2,
            name: 'CompanyBrain_AI',
            applicationCategory: 'Enterprise AI',
            operatingSystem: 'Cloud',
            description:
              'Autonomous AI Executive that connects contracts, financials, and roadmaps to eliminate enterprise blind spots.',
            url: 'https://devpost.com/software/companybrain_ai',
            author: { '@id': 'https://ashokpasala.vercel.app/#person' },
          },
          {
            '@type': 'SoftwareApplication',
            position: 3,
            name: 'Qwen Chaos MemoryAgent',
            applicationCategory: 'Neural AI',
            operatingSystem: 'Cloud',
            description:
              'Self-persistent AI MemoryAgent proving cross-session recall and state persistence across live interactive sessions.',
            url: 'https://devpost.com/software/qwen-chaos',
            author: { '@id': 'https://ashokpasala.vercel.app/#person' },
          },
          {
            '@type': 'SoftwareApplication',
            position: 4,
            name: 'ResQNet Disaster Response Grid',
            applicationCategory: 'Geospatial AI',
            operatingSystem: 'Cloud',
            description:
              'Real-time AI crisis response platform that coordinates rescue operations, detects incident severity, and connects citizens with life-saving resources.',
            url: 'https://devpost.com/software/resqnet',
            author: { '@id': 'https://ashokpasala.vercel.app/#person' },
          },
          {
            '@type': 'SoftwareApplication',
            position: 5,
            name: 'LaunchLens Due Diligence Platform',
            applicationCategory: 'Market Intelligence',
            operatingSystem: 'Cloud',
            description:
              'Multi-model AI platform providing instant market validation and due diligence for founders and venture capital firms.',
            url: 'https://devpost.com/software/launchlens',
            author: { '@id': 'https://ashokpasala.vercel.app/#person' },
          },
        ],
      },
