...
<body>
  ...
  <header class="header">
    ...
    <div class="contact-block">
      ...
      <div><a href="https://github.com/ashokwebs">github.com/ashokwebs</a> • <a href="https://linkedin.com/in/ashok-raj-p-1b8539317">linkedin.com/in/ashok-raj-p-1b8539317</a> • <a href="https://x.com/ashokfounds">@ashokfounds</a></div>
    </div>
  </header>
  ...
  <section class="section">
    ...
    <p class="summary-text">
      <strong>Founder, AI Systems Architect, and Deep Tech Engineer</strong> building sovereign AI infrastructure, autonomous multi-agent orchestration frameworks, and high-concurrency distributed backend systems from first principles. Founder of <strong>Varellen Technologies</strong> (enterprise systems engineering & scalable platforms) and <strong>Norveth</strong> (<a href="https://norveth.app">norveth.app</a> — AI website intelligence & Model Context Protocol tooling). Computer Science & Distributed Systems background at <strong>VIT-AP University</strong> (2024–2028).
    </p>
  </section>
  ...
  <section class="section">
    ...
    <div class="item">
      ...
      <ul class="bullets">
        <li>Guiding venture roadmap and system design for enterprise digital platforms, autonomous AI workflow pipelines, and high-throughput cloud infrastructure.</li>
    ...
    <div class="item">
      <div class="item-header">
        ...
        <span class="item-date">2024 – PRESENT | AI INTELLIGENCE</span>
      </div>
      <ul class="bullets">
  ...
  <section class="section">
    <div class="section-title">Flagship Architectures &amp; Software Systems</div>

    <div class="item">
      <div class="item-header">
        <div>
          <span class="item-title">Multi-Agent Orchestration Platform</span>
          <span class="highlight-badge">Autonomous AI</span>
        </div>
        <span class="item-date">Python, FastAPI, LangChain, Redis, Vector DBs</span>
      </div>
      <ul class="bullets">
        <li>Autonomous execution kernel where specialized agent personas collaborate on complex, multi-stage workflows with deterministic routing, shared vector memory persistence, and asynchronous tool invocation.</li>
      </ul>
    </div>
    ...
    <div class="item">
      <div class="item-header">
        <div>
          <span class="item-title">AI Workflow Automation Engine</span>
          <span class="highlight-badge">Enterprise Automation</span>
        </div>
        <span class="item-date">Next.js 16, Node.js, PostgreSQL, Docker, WebSockets</span>
      </div>
      <ul class="bullets">
        <li>Visual pipeline compiler translating high-level natural language instructions into distributed, fault-tolerant worker execution graphs with live WebSocket telemetry.</li>
      </ul>
    </div>
    ...
    <div class="item">
      <div class="item-header">
        <div>
          <span class="item-title">OSPRED Autonomous Security Engine</span>
          <span class="highlight-badge">Cybersecurity</span>
        </div>
        <span class="item-date">Python, FastAPI, Docker, Linux Hardening, CVE Feeds</span>
      </div>
      <ul class="bullets">
        <li>AI-assisted security platform executing continuous vulnerability surface discovery, automated threat intelligence synthesis, and zero-trust Linux server hardening.</li>
      </ul>
    </div>
    ...
    <div class="item">
      <div class="item-header">
        <div>
          <span class="item-title">Neural Knowledge Retrieval Engine &amp; ShadowForge Intelligence</span>
          <span class="highlight-badge">RAG &amp; Web3</span>
        </div>
        <span class="item-date">Python, ChromaDB, OpenAI, Solidity, Web3.js</span>
      </div>
      <ul class="bullets">
        <li>Sub-millisecond dense vector RAG engine over unstructured corpora alongside an EVM ledger intelligence engine for heuristic pattern recognition & smart contract audits.</li>
      </ul>
    </div>
  </section>
  ...
  <section class="section">
    <div class="section-title">Education &amp; Competitions</div>
    <div class="edu-row">
      <div>
